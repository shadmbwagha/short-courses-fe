  ...
  <div class="py-24">
     <div class="flex items-center max-w-sm mx-auto overflow-hidden bg-white rounded-lg shadow-lg">
         ...
         <div class="w-full p-8 ">
             <h2 class="text-2xl font-semibold text-center text-blue-700">DIT - IT/ICT</h2>
             
             <form @submit.prevent='handleLogin'>
                 <div class="mt-4">
                     <label class="block mb-2 text-sm font-bold text-gray-700">Email Address</label>
                     <input class="block w-full px-4 py-2 text-gray-700 bg-gray-200 border border-gray-300 rounded appearance-none focus:outline-none focus:shadow-outline" type="email" v.model='form.email' />
                 </div>
                 <div class="mt-4">
                     ...
                     <input class="block w-full px-4 py-2 text-gray-700 bg-gray-200 border border-gray-300 rounded appearance-none focus:outline-none focus:shadow-outline" type="password" v.model="form.password"/>
                 </div>
                 <div class="mt-8">
                 <div class="mt-12">
